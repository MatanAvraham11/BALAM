...
## דיוק שמות (יוסי מול יוסף וכו׳)

מנועי OCR (כולל OCR.space) לפעמים מבלבלים בין אותיות עבריות דומות בפיקסלים נמוכים או בפונטים דקים — למשל **י** מול **ו**, או צירופים כמו **יוסי** לעומת **יוסף**. הקוד **לא** מתקן אוטומטית שמות פרטיים (אין מילון קניין), כדי לא לשבור שמות אמיתיים. אם הטקסט ב־PDF ברור, אפשר לתקן ידנית בשורה שמיוצאת ל־TSV/אקסל.
